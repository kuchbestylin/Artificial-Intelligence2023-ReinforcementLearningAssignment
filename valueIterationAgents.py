...
class ValueIterationAgent(ValueEstimationAgent):
    ...
    def __init__(self, mdp, discount = 0.9, iterations = 100):
        ...
        #     # Make a copy of the old values to update them in place
        #     new_values = self.values.copy()

        #     # For each state, compute the maximum expected value
        ...
        #     # Update the agent's value estimates
    ...
    def computeQValueFromValues(self, state, action):
        ...
        # Compute the expected value of taking the given action in the given state
